...
/**
 * Clasa ce defineste operatorul pentru radical.
 *
 * @author Brinzan Ionut 324CD
 *
 */
public class SqrtOperator extends Token implements IUnaryOperator<Number> {

    private static final int PRIOR_THREE = 3;

    /**
     * Constructor ce creaza un SqrtOperator.
     * @param token reprezinta simbolul
     */
    public SqrtOperator(final String token) {
    ...
    public IOperand<Number> calculate(final Number operand) {
        ...
        resultValue = Math.sqrt(operand.doubleValue());
