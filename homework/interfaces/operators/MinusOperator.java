...
/**
 * Clasa ce defineste operatorul pentru scadere.
 *
 * @author Brinzan Ionut 324CD
 *
 */
public class MinusOperator extends Token implements
        IBinaryOperator<Number> {

    private static final int PRIOR_ZERO = 0;

    /**
     * Constructor ce creaza un MinusOperator.
     * @param token reprezinta simbolul
     */
    public MinusOperator(final String token) {
